Create one horizontal animation strip for Codex pet `blue-dumpling`, state `running-right`.
...
Identity: same pet in every frame: A foolish, plump, round blue shorthair cat mascot named 蓝团, with tiny paws, chubby cheeks, sleepy confused eyes, a small dumb smile, compact whole-body silhouette, blue fur with darker blue ear tips and tail, no props.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `sticker`: Polished sticker mascot with bold clean shapes, crisp outline, flat colors, and minimal highlight detail. User style notes: clean chunky sticker mascot, crisp outline, simple readable shapes, pet-safe sprite style.
