...
const menuOptions: MenuOption[] = [
  ...
  // Phase F5: { label: '考试管理', key: '/teacher/exams', icon: renderIcon(DocumentTextOutline) },
  // Phase F5: { label: '项目管理', key: '/teacher/projects', icon: renderIcon(...) },
  // Phase 5b: { label: '数据分析', key: '/teacher/stats', icon: renderIcon(...) },
  // Phase F6: { label: '成绩导出', key: '/teacher/export', icon: renderIcon(...) },
]
