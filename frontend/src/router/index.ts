...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'exams/:examId/submissions', name: 'TeacherExamSubmissions', component: () => import('@/views/teacher/ExamGradingView.vue') },
      { path: 'projects', name: 'TeacherProjects', component: () => import('@/views/teacher/ProjectManage.vue') },
      { path: 'projects/:projectId/submissions', name: 'TeacherProjectSubmissions', component: () => import('@/views/teacher/ProjectGradingView.vue') },
      { path: 'stats', name: 'TeacherStats', component: () => import('@/views/teacher/ClassStats.vue') },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'tasks', name: 'StudentTasks', component: () => import('@/views/student/TaskInboxView.vue') },
      { path: 'tasks/:taskId/result', name: 'StudentTaskResult', component: () => import('@/views/student/TaskResult.vue') },
